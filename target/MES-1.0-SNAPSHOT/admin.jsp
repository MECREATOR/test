...
<div class="container-fluid">
  <div class="row">
    <div class="col-sm-2">
      ...
      <a href="javascript:void(0)" class="list-group-item active" onclick="change('/manageplanner.jsp?method=list',0)">
						<span class="" aria-hidden="true">
							<i class="fa fa-user-circle-o fa-fw"></i>
						</span>Planner Management
      </a>
      <a href="javascript:void(0)" class="list-group-item" onclick="change('/managecustomer.jsp?method=list',1)">
						<span class="" aria-hidden="true">
    ...
    <!--right content-->
    <iframe style="width: 81%; height: 600px; border: 0px;" src="/planner?method=list"></iframe>
  </div>
</div>
<div class="footer">
  <p class="text-center">
